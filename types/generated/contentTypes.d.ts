...
export interface ApiPayrollPeriodPayrollPeriod
  extends Struct.CollectionTypeSchema {
  collectionName: 'payroll_periods';
  info: {
    displayName: 'PayrollPeriod';
    pluralName: 'payroll-periods';
    singularName: 'payroll-period';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiPayslipPayslip extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    withholding_tax: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
  };
}
